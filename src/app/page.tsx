...
export default function Home() {
  ...
  return (
    <main className="relative max-w-screen-md p-4 md:p-6 mx-auto flex min-h-svh !pb-32 md:!pb-40 overflow-y-auto">
            ...
            {INITIAL_QUESTIONS.map((message) => {
              return (
                <button
                  ...
                  border border-zinc-200 rounded-xl p-3 md:px-4 md:py-3
                  bg-zinc-100 dark:bg-zinc-900
                  hover:bg-zinc-50 hover:border-zinc-400
                  dark:hover:bg-zinc-800/50 dark:hover:border-zinc-500
                  text-zinc-900 dark:text-zinc-100 dark:border-zinc-800
                  "
      ...
      >
        <span
          className="absolute bottom-full h-10 inset-x-0 bg-zinc-100
            dark:bg-zinc-900 pointer-events-none"
        />

        <div className="w-full max-w-screen-md rounded-xl px-4 md:px-5 py-6 bg-zinc-100 dark:bg-zinc-900">
          <Form
            ref={formRef}
            onSubmit={onSubmit}
            inputProps={{
